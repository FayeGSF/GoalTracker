...
function Header() {
  return (
    <nav style={{ padding: "1rem", backgroundColor: "#eee", textAlign:"center"}}>
      <Link to="/" style={{ marginRight: "1rem" , textDecoration: "none", fontFamily: "Monospace", fontSize: "16px"}}>📰 News</Link>
      <Link to="/setgoal" style={{ marginRight: "1rem" , textDecoration: "none", fontFamily: "Monospace", fontSize: "16px"}}>🏁 Goal Form</Link>
